<section x-data="{open : true}">
    <div class="container mx-auto px-4 py-4 lg:px-20 lg:py-28 items-center justify-center mt-12 lg:mt-0">
        ...
        <div class="p-4">
            ...
            <div class="rounded-lg w-full lg:w-9/12 mx-auto bg-white shadow-xl">
                <form action="/user/register" method="post" class="flex flex-col gap-3">
                    <div class="flex flex-col gap-1 px-4 mt-4">
                        <label for="" class="text-xl font-semibold">Username</label>
                        <input type="text" name="username" class="border-2 border-abu rounded-lg p-2" value="<?= $model['post_username'] ?? "" ?>">
                    </div>
                    <div class="flex flex-col gap-1 px-4 mt-4">
                        <label for="" class="text-xl font-semibold">Email</label>
                        <input type="email" name="email" class="border-2 border-abu rounded-lg p-2" value="<?= $model['post_email'] ?? "" ?>">
                    </div>
                    <div class="flex flex-col gap-1 px-4">
                        <label for="" class="text-xl font-semibold">Nama</label>
                        <input type="text" name="name" class="border-2 border-abu rounded-lg p-2" value="<?= $model['post_name'] ?? "" ?>">
                    </div>
                    <div class="flex flex-col gap-1 px-4">
                        <label for="" class="text-xl font-semibold">Nomor HP</label>
                        <input type="number" name="phone" class="border-2 border-abu rounded-lg p-2" value="<?= $model['post_phone'] ?? "" ?>">
                    </div>
                    <div class="flex flex-col gap-1 px-4">
                    ...
                    <div class="flex items-center justify-center mb-4 px-4 mt-4">
                        <button type="submit" class="font-semibold text-dark-white text-center bg-merah rounded-lg text-xl w-full p-2">Daftar</button>
                    </div>
                </form>
            </div>
        </div>
