                            ...
                            <div class="h-full overflow-hidden rounded-lg shadow-lg">
                                ...
                                <div class="p-6 transition duration-200 ease-in hover:bg-merah hover:text-white">
                                    ...
                                    <div class="flex flex-row items-end justify-end gap-2">
                                        <label>
                                            <a onclick="return confirm('Anda yakin ingin menghapus produk ini? (<?= $row['name'] ?>)')" href="/admin/products/delete/<?= $row['id'] ?>" class="px-4 py-2 border-2 border-white bg-merah rounded-xl text-dark-white">Hapus</a>
                                        </label>
                                        <label><a href="/admin/products/edit/<?= $row['id'] ?>" class="px-4 py-2 border-2 border-white bg-merah rounded-xl text-dark-white">Edit</a></label>
                                    </div>
                                </div>
                            </div>
                        </div>
