                        ...
                        <div class="h-full py-10 rounded-lg shadow-xl">
                            <form method="post" action="/admin/add-products" enctype="multipart/form-data">
                                <div class="flex flex-col w-9/12 gap-2 mx-auto">
                                    ...
                                    <input type="text" name="products_name" class="px-4 py-2 rounded-md font-rubik bg-dark-white" required placeholder="Nama produk">
                                </div>
                                <div class="flex flex-col w-9/12 gap-2 mx-auto">
                                ...
                                <div class="flex flex-col w-9/12 gap-2 mx-auto">
                                    ...
                                    <input type="number" name="products_price" class="px-4 py-2 rounded-md font-rubik bg-dark-white" required placeholder="Harga produk">
                                </div>
                                <div class="flex flex-col w-9/12 gap-2 mx-auto">
                                    <label for="judul" class="font-semibold">Stok</label>
                                    <input type="number" name="products_quantity" class="px-4 py-2 rounded-md font-rubik bg-dark-white" required placeholder="Stok">
                                </div>
                                <div class="flex flex-col w-9/12 h-48 gap-2 mx-auto">
                                    <label for="judul" class="mt-2 font-semibold">Deskripsi produk</label>
                                    <textarea name="products_description" id="" cols="30" rows="10" class="px-4 rounded-md bg-dark-white font-rubik" required placeholder="Deskripsi produk"></textarea>
                                </div>
                                <!-- <div class="flex flex-col w-9/12 gap-2 mx-auto">
                                ...
                                <div class="w-9/12 mx-auto mt-4">
                                    <button class="py-2 font-semibold text-white rounded-lg bg-merah px-9" type="submit">Tambah</button>
                                </div>
                            </form>
                        </div>
                    </div>
