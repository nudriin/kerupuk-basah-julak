        ...
        <div class="w-full p-4">
            <div class="h-full mx-auto overflow-hidden rounded-lg shadow-lg lg:w-9/12">
                <div class="grid items-center justify-center grid-cols-12 gap-4 p-4">
                    <form action="/admin/profile" method="post" class="z-0 flex flex-col items-center justify-center col-span-12 gap-2" enctype="multipart/form-data">
                        <div class="relative inset-0 col-span-12 mx-auto mb-5 text-center">
                            <!-- <div class="relative"> -->
                            <img src="<?= getUploadedImg("profile/" . $model['admin_profile']) ?? '' ?>" alt="" id="profile_image" class="object-cover object-center w-48 h-48 border-4 rounded-full border-abu">
                        ...
                        <p class="w-full col-span-12 p-3 overflow-hidden border-2 rounded-lg border-abu bg-dark-white"><?= $model['admin']->email ?></p>
                        <input class="w-full p-3 mb-4 border-2 rounded-lg border-abu" type="text" value="<?= $model['admin']->name ?? $model['admin_name'] ?>" name="name" required>
                        <div>
